...
import com.vworks.hs.home_service.models.*;
...
import com.vworks.hs.common_lib.utils.DateTimeFormatUtil;
...
import com.vworks.hs.home_service.service.ExportBillService;
...
//                predicates.add(code);
    ...
    public BaseResponse<?> assignAproval(PostAssignApprovalRequestBody requestBody, HttpServletRequest httpServletRequest) throws WarehouseMngtSystemException {
        ...
        String userId = StringUtils.isNotEmpty(httpServletRequest.getHeader(com.vworks.hs.common_lib.utils.Commons.FIELD_USER_ID)) ? httpServletRequest.getHeader(com.vworks.hs.common_lib.utils.Commons.FIELD_USER_ID) : null;
